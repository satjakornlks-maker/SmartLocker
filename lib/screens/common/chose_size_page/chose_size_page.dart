...
import 'package:untitled/screens/common/chose_size_page/chose_size_component/chose_size_main_content.dart';
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    // Center content
                    ChoseSizeMainContent(from: widget.from,mode: widget.mode,)
                  ],
                ),
              ),
            ),
